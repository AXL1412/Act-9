...
public class EmployeeDao {
    ...
    public int update(Employee e) {
        ...
        values.put(DBContract.EmployeeEntry.COL_POSITION, e.getPosition());
        values.put(DBContract.EmployeeEntry.COL_SALARY, e.getSalary());
        return db.update(DBContract.EmployeeEntry.TABLE_NAME, values, DBContract.EmployeeEntry._ID + " = ?", new String[]{String.valueOf(e.getId())});
    }

    public int delete(long id) {
        SQLiteDatabase db = helper.getWritableDatabase();
        return db.delete(DBContract.EmployeeEntry.TABLE_NAME, DBContract.EmployeeEntry._ID + " = ?", new String[]{String.valueOf(id)});
    }
